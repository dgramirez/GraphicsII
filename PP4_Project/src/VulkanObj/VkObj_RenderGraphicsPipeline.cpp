...
// 
// bool vk_create_render_pass(const VkPhysicalDevice &physical_device, const VkDevice &device, const VkFormat &swapchain_format, 
// 	const VkSampleCountFlagBits &msaa, VkRenderPass &render_pass)
// {
